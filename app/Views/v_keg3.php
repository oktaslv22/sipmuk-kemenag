...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Sosialisasi BOP</h6>
            <a href="<?= site_url('admin/export3') ?>" class="btn btn-sm btn-outline-secondary"
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url("admin/biodata3/delete/$row->id_biodata") ?> "
                ...
                <?= $pager->links('biodata3', 'biodata_pagination'); ?>
            </div>
        </div>
    </div>
</div>