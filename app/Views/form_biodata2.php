...
<head>
    ...
    <title>SIPMUK - WORKSHOP HALAQOH</title>
</head>
<style>
form {
    background: #f9f9f9;
...
<body>
    ...
    <div class="container mt-3">
        ...
        <div class="card-body">
            ...
            <form id="form" method="POST" action="<?= base_url('/biodata/store2') ?>">
                ...
                <div class="mb-1 row">
                    ...
                    <div class="col-sm-7">
                        <textarea id="alamat_rumah" name="alamat_rumah" class="form-control"
                            value="<?= old('alamat_rumah') ?>" placeholder="Masukkan Alamat Lengkap"></textarea>
                    </div>
                </div>
                ...
                <center>
                    <button type="submit" name="submit" class="btn btn-success" id="simpanData2">Submit</button>
    ...
    <script>
    // $('#simpanData2').on('click', function() {
    //     alert('Terima kasih, Anda sudah terdaftar di kegiatan Workshop Halaqoh!:)');
    // });
    </script>
</body>
