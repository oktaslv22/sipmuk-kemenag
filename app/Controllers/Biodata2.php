...
class Biodata2 extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($keyword) {
            $biodata2 = $this->M_biodata2->search($keyword);
        } else {
            $biodata2 = $this->biodata2;
        }

        // $data['biodata'] = $this->biodata->findAll();
        $data['biodata2'] = $biodata2->paginate(10, 'biodata2');
        $data['pager'] = $this->biodata2->pager;
    ...
    function delete($id)
    {
        ...
        return redirect()->to('admin/view_keg2');
    }
    ...
    {
        $biodata2 = $this->biodata2->findAll();
        ...
        header('Content-Disposition: attachment;filename=WorkshopHalaqoh.xlsx');
